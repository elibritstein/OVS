...
if HAVE_DOT
# Same VPATH vs. $(CURDIR) rationale as vswitchd/automake.mk.
VTEP_GV = $(CURDIR)/vtep/vtep.gv
VTEP_PIC = $(CURDIR)/vtep/vtep.pic
$(VTEP_GV): ovsdb/ovsdb-dot.in vtep/vtep.ovsschema
	$(AM_V_GEN)$(OVSDB_DOT) --no-arrows $(srcdir)/vtep/vtep.ovsschema > $@
$(VTEP_PIC): $(VTEP_GV) ovsdb/dot2pic
	$(AM_V_GEN)(dot -T plain < $(VTEP_GV) | $(PYTHON3) $(srcdir)/ovsdb/dot2pic -f 3) > $@.tmp && \
	mv $@.tmp $@
