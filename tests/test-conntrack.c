...
static void
test_nat_dst_null_binding_collision(struct ovs_cmdl_context *ctx OVS_UNUSED)
{
    struct eth_addr eth_src = ETH_ADDR_C(50, 54, 00, 00, 00, 09);
    struct eth_addr eth_dst = ETH_ADDR_C(50, 54, 00, 00, 00, 0a);
    ovs_be32 ip_dnat = inet_addr("172.1.1.2");
...
static const struct ovs_cmdl_command commands[] = {
    ...
    {"nat-dst-null-binding-collision", "", 0, 0,
        test_nat_dst_null_binding_collision, OVS_RO},
